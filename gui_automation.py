...
def get_button_position(image_name):
    ...
    if getattr(sys, 'frozen', False):
        base_path = os.path.join(sys._MEIPASS, "assets")  # When running as an executable
    else:
        base_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "assets")  # When running as a script
